  ...
  <div x-data="modalData()">
    ...
    <div class="py-10 container mx-auto px-4">
      <div class="bg-white shadow rounded-lg overflow-hidden">
        ...
        <td class="px-4 py-2">
        <button @click.prevent="openModal('{{ $item->id }}')"
    ...
    <div x-show="open" x-cloak class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div class="bg-white rounded-lg shadow-lg w-full max-w-md overflow-hidden">
        <form :action="actionUrl" method="POST" class="space-y-4" @submit="prepareSubmit">
          @csrf
          ...
          <div class="px-6 py-4 space-y-4">
            <div>
              <label class="inline-flex items-center">
                <input type="checkbox" x-model="defeito" class="form-checkbox h-5 w-5 text-indigo-600 rounded" />
            ...
            <div x-show="defeito" x-cloak>
              ...
              <textarea id="observacao" name="observacao" x-bind:required="defeito" rows="3"
            ...
            <div>
              ...
              <input type="date" id="data_retorno" name="data_retorno" x-bind:value="today"
          ...
          <div class="px-6 py-4 bg-gray-50 flex justify-end space-x-2">
            <button type="button" @click="close()"
              class="px-4 py-2 bg-gray-300 rounded hover:bg-gray-400 focus:outline-none">Cancelar</button>
            <button type="submit"
              class="px-4 py-2 bg-indigo-600 text-white rounded hover:bg-indigo-700 focus:outline-none">Confirmar</button>
          </div>
        </form>
      </div>
    </div>
