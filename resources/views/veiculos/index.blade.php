  ...
  <div class="py-8">
    <div class="container mx-auto px-4 space-y-8">
      ...
      <div class="overflow-x-auto">
        ...
        onclick="showEditForm({{ $veiculo->id }})">Editar</button>
        ...
        <button type="submit"
          ...
          onclick="return confirm('Deseja excluir este veículo?')">Excluir</button>
        </form>
        </td>
        </tr>
        ...
        <td class="px-4 py-2 text-sm">
        <input type="number" name="km_atual" value="{{ $veiculo->km_atual }}"
          class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm" />
        </td>
        ...
        <button type="button" onclick="cancelEdit({{ $veiculo->id }})"
