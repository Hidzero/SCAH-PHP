...
<x-app-layout>
  ...
  <div class="py-10 container mx-auto px-4">
    <div class="bg-white rounded-lg shadow overflow-hidden">
      ...
      <div class="p-6">
        <form action="{{ route('veiculos.saida.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
          @csrf
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input type="number" name="km_atual" id="km_atual" required
                     value="{{ old('km_atual') }}"
                     class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
          ...
          <div id="avarias_container" class="grid grid-cols-1 mt-4" style="display:none;">
            <label for="avarias_descritas" class="block text-sm font-medium text-gray-700">{{ __('Descreva as avarias') }}</label>
